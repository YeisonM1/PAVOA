...
export default function ContactPage() {
  ...
  const [content, setContent] = useState(CONTACT_PAGE_DEFAULTS);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        className="w-full pt-[140px] md:pt-[160px] pb-8 md:pb-12 px-6 border-b border-stone-100"
            ...
            <div>
              ...
              <div className="flex flex-col gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold tracking-[0.15em] uppercase text-stone-900 mb-1">{content.emailLabel}</p>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-bold tracking-[0.15em] uppercase text-stone-900 mb-1">{content.scheduleLabel}</p>
          ...
          <div className="lg:col-span-3">
            ...
            {estado === 'success' ? (
              <div className="flex flex-col items-center justify-center py-20 gap-6 text-center border border-stone-100">
                ...
                <div>
                  <p className="text-[11px] font-bold tracking-[0.2em] uppercase text-stone-900 mb-2">{content.successTitle}</p>
                  <p className="text-[12px] text-stone-500 tracking-[0.08em]">{content.successBody}</p>
                </div>
                <button
              ...
              <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-10">
                ...
                >
                  {estado === 'loading' ? content.submittingButtonText : content.submitButtonText}
                </button>
              </form>
            )}
          </div>
